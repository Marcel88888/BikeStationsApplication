...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void insertReport(Integer stationId, String name, String description, String status, String type, byte[] photo) {
        ...
        contentValues.put(DBHelper.REPORT_PHOTO, photo);

        dataBase.insert(DBHelper.TABLE_NAME, null, contentValues);
    }

    public void updateReport(Integer stationId, Integer reportId, String name, String description, String status, String type, byte[] photo) {
        contentValues = new ContentValues();
    ...
    public Cursor findReportById(Integer reportId) {
        return dataBase.query(DBHelper.TABLE_NAME,
                new String[] {DBHelper.REPORT_NAME, DBHelper.REPORT_DESCRIPTION, DBHelper.REPORT_STATUS, DBHelper.REPORT_TYPE, DBHelper.REPORT_PHOTO},
